...
export default function PrismHero() {
    return (
        <section className="h-screen w-full relative overflow-hidden bg-black">
            ...
            {/* Overlay Content */}
            <div className="relative z-10 h-auto mt-25 flex flex-col items-center justify-center text-center px-4 pointer-events-none opacity-95">
                <motion.div
                ...
                >
                    ...
                    <motion.h1 className="text-2xl text-gray-400" > The <span className="text-cyan-400 font-bold">SAGA</span> BEGINS IN</motion.h1>

                    {/* Timer implementation inserted below the text */}
                    <motion.div
                        initial={{ y: 20, opacity: 0 }}
                        animate={{ y: 0, opacity: 1 }}
